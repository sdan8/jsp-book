...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="form">
				<!--<h2 class="theme-color">添加管理员</h2>-->
			
				<form action="<%=contextPath %>/AdminServlet?info=add" method="post" class="form-horizontal">
					<table class="table">
						<tr>
						...
						<tr>
							...
							<td><input type="password" class="form-control" name="adminPassword" /></td>
						</tr>
						<tr>
							<td colspan="2"><button class="btn btn-primary">添加</button></td>
						</tr>
					</table>
				</form>
			</div>
